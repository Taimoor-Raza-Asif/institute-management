            ...
            <ul>
                  ...
                  <li className="mb-2">
                    ...
                    {openDropdowns['academic-management'] && (
                      <ul className="mt-1 ml-4 border-l border-gray-500">
                        ...
                        <li className="mb-2">
                          <Link to="/admin/marks" className="flex items-center p-2 text-sm md:text-base rounded-md hover:bg-gradient-to-r from-gray-800 to-white transition duration-200" onClick={toggleSidebar}>
              ...
              {currentUser.role === 'student' && (
                <>
                  ...
                  <li className="mb-2">
                    <Link to={getMyMarksLink()}  className="flex items-center p-2 text-sm md:text-base rounded-md hover:bg-gradient-to-r from-gray-800 to-white transition duration-200" onClick={toggleSidebar}>
                  ...
                  <li className="mb-2">
                    ...
                    {openDropdowns['teacher-classes'] && (
                      <ul className="mt-1 ml-4 border-l border-gray-500">
                        ...
                        <li>  
                          <Link to="/teacher/my-subjects" className="flex items-center p-2 text-sm md:text-base rounded-md hover:bg-gradient-to-r from-gray-800 to-white transition duration-200" onClick={toggleSidebar}>
                        ...
                        <li className="mb-2">
                          <Link to="/marks/add" className="flex items-center p-2 text-sm md:text-base rounded-md hover:bg-gradient-to-r from-gray-800 to-white transition duration-200" onClick={toggleSidebar}>
