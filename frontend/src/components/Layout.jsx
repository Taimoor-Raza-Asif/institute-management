...
import {
  ...
  Bars3Icon, XMarkIcon, ClockIcon, ClipboardDocumentCheckIcon, UserGroupIcon
            ...
            <ul>
              ...
              {currentUser.role === 'admin' && (
                <>
                  ...
                  <li className="mb-2">
                    <Link to="/admin/salaries" className="flex items-center p-2 rounded-md hover:bg-gray-800 transition duration-200">
