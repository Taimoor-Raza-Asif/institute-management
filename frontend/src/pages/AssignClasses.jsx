...
//       setError("At least one subject is required for an assignment.");
//       return;
//     }
...
//       const updatedList = [...newAssignments];
//       updatedList[editingAssignmentIndex] = assignment;
//       setNewAssignments(updatedList);
//     } else {
...
//       const teacher = allTeachers.find(t => t._id === selectedStaff);
//       const existingAssignments = teacher ? teacher.assignClasses : [];
//       const combinedAssignments = [...existingAssignments, ...newAssignments];
...
//     setNewAssignments(teacher.assignClasses);
...
//           <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Assignment Form</h3>
...
//                   className="block w-full pl-10 pr-4 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
//                 />
//                 <select
//                   id="teacher"
//                   value={selectedStaff}
//                   onChange={(e) => { setSelectedStaff(e.target.value); setNewAssignments([]); }}
...
//               <h3 className="text-xl font-semibold text-gray-900 mb-4">Add/Edit Assignments for this Teacher</h3>
...
//                     className="mt-3 w-full inline-flex items-center justify-center px-4 py-2 border border-dashed border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100"
//                   >
...
//                   >
//                     {editingAssignmentIndex !== null ? "Update Assignment" : "Add to List"}
//                   </button>
...
//                 <h3 className="text-xl font-semibold text-gray-900 mb-4">Assignments to be Saved ({newAssignments.length})</h3>
//                 <ul className="divide-y divide-gray-200 rounded-md border border-gray-200">
//                   {newAssignments.map((assignment, index) => (
//                     <li key={index} className="p-4 flex justify-between items-center bg-gray-50">
//                       <div>
...
//                   <button
//                     type="submit"
//                     className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200 shadow-md flex items-center"
//                   >
