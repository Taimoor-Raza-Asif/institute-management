  ...
  return (
    <div className="flex flex-col h-full p-4 sm:p-6 lg:p-8 bg-white rounded-lg shadow-xl">
      ...
      <div className="flex-shrink-0 relative">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-center text-green-700">{getTitle()}</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
          ...
          <div className="sm:col-span-2 lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            ...
            <div>
              ...
              <input type="text" id="name" name="name" value={staff.name} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            ...
            <div>
              ...
              <input
                ...
                required
                readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
              />
            ...
            <div>
              ...
              <select id="staffType" name="staffType" value={staff.staffType} onChange={handleChange} disabled={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}>
            ...
            <div>
              ...
              <input type="text" id="cnic" name="cnic" value={staff.cnic} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            ...
            <div>
              ...
              <input type="text" id="contactNumber" name="contactNumber" value={staff.contactNumber} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
              {fieldErrors.contactNumber && <p className="mt-1 text-sm text-red-600">{fieldErrors.contactNumber}</p>}
            </div>
            {/* Email */}
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email</label>
              <input type="email" id="email" name="email" value={staff.email} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            ...
            <div>
              ...
              <input type="date" id="dateOfJoining" name="dateOfJoining" value={staff.dateOfJoining} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            ...
            <div>
              ...
              <input type="number" id="salary" name="salary" value={staff.salary} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            ...
            <div>
              ...
              <input type="text" id="emergencyContact" name="emergencyContact" value={staff.emergencyContact} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            ...
            <div className="sm:col-span-2">
              ...
              <textarea id="address" name="address" value={staff.address} onChange={handleChange} readOnly={isViewMode} rows="2" className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}></textarea>
        ...
        <div className="border-t pt-4 mt-4 border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-4">
            ...
            <div>
              ...
              <select id="highestEducationLevel" name="highestEducationLevel" value={staff.highestEducationLevel} onChange={handleChange} disabled={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}>
          ...
          <div className="mb-4">
            ...
            {!isViewMode && (
              <button type="button" onClick={addDegree} className="mb-3 bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition">
                Add Degree
              </button>
            )}
            ...
            {staff.degrees.map((degree, index) => (
              <div key={index} className="grid grid-cols-1 sm:grid-cols-4 gap-4 md:gap-6 border p-3 rounded-md mb-3 relative">
                <div>
                  ...
                  <input type="text" id={`degreeName-${index}`} name="degreeName" value={degree.degreeName} onChange={(e) => handleDegreeChange(index, e)} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
                ...
                <div>
                  ...
                  <input type="text" id={`major-${index}`} name="major" value={degree.major} onChange={(e) => handleDegreeChange(index, e)} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
                </div>
                <div>
                  ...
                  <input type="text" id={`institution-${index}`} name="institution" value={degree.institution} onChange={(e) => handleDegreeChange(index, e)} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
                </div>
                <div>
                  ...
                  <input type="number" id={`yearCompleted-${index}`} name="yearCompleted" value={degree.yearCompleted} onChange={(e) => handleDegreeChange(index, e)} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
                </div>
                {!isViewMode && (
        ...
        {staff.staffType === 'Teacher' && (
          <div className="border-t pt-4 mt-4 border-gray-200">
            ...
            <div className="mb-4">
              ...
              {!isViewMode && (
                <button type="button" onClick={addSubject} className="mb-3 bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition">
                  Add Subject
                </button>
              )}
              ...
              {staff.subjectsTaught.map((subject, index) => (
                <div key={index} className="flex items-center space-x-2 mb-2">
                  <input type="text" value={subject} onChange={(e) => handleSubjectChange(index, e)} readOnly={isViewMode} className={`flex-grow px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
                  {!isViewMode && (
        ...
        <div className="border-t pt-4 mt-4 border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-4">
            <div>
              ...
              <input type="text" id="bankName" name="bankAccountDetails.bankName" value={staff.bankAccountDetails.bankName} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            </div>
            <div>
              <label htmlFor="accountNumber" className="block text-sm font-medium text-gray-700">Account Number</label>
              <input type="text" id="accountNumber" name="bankAccountDetails.accountNumber" value={staff.bankAccountDetails.accountNumber} onChange={handleChange} readOnly={isViewMode} className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`} />
            </div>
            <div className="sm:col-span-2">
...
//   const canEdit = user && (
//     user.role === 'admin' ||
//     (user.profileId === editingStaff?._id && user.editModeEnabled)
//   );
//   // Determine if the current user can add a new staff member
//   const canAdd = user && (user.role === 'admin' || user.editModeEnabled);
...
//                 alt="Profile"
//                 className="w-32 h-32 rounded-full object-cover mb-3 border-2 border-green-300"
//               />
//             )}
...
//               value={staff.name}
//               onChange={handleChange}
//               className={`mt-1 block w-full p-2 border ${fieldErrors.name ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             />
...
//               onChange={handleChange}
//               className={`mt-1 block w-full p-2 border ${fieldErrors.staffType ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             >
//               <option value="">Select Type</option>
//               {staffTypes.map(type => (
...
//               onChange={handleChange}
//               className={`mt-1 block w-full p-2 border ${fieldErrors.contactNumber ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             />
...
//               value={staff.email}
//               onChange={handleChange}
//               className={`mt-1 block w-full p-2 border ${fieldErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             />
...
//               onChange={handleChange}
//               className={`mt-1 block w-full p-2 border ${fieldErrors.dateOfJoining ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             />
...
//               value={staff.salary}
//               onChange={handleChange}
//               className={`mt-1 block w-full p-2 border ${fieldErrors.salary ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             />
...
//               onChange={handleChange}
//               className={`mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             />
//           </div>
...
//               onChange={handleChange}
//               rows="3"
//               className={`mt-1 block w-full p-2 border ${fieldErrors.address ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
//               disabled={isViewMode}
//             ></textarea>
...
//                 className={`mt-1 block w-full p-2 border ${fieldErrors.subjectsTaught ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${isViewMode ? 'bg-gray-50' : ''}`}
