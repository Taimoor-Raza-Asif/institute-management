...
// // New internal registration function
...
//     role,
//     profileId, // This is the _id of the associated Student/Staff document
//     roleMapping,
//     editModeEnabled: false, // Default to false for new users
//   });

//   if (newUser) {
//     // Optionally generate a token, though not strictly needed for internal creation
...
//   const { cnic, password } = req.body; // Removed 'role' from destructuring as it's fetched from user model

//   // Input validation for CNIC and password
//   if (!cnic || !password) {
//     res.status(400);
...
//     let profileName = user.cnic; // Default to CNIC if profile not found or not applicable
//     if (user.profileId) {
...
//       _id: user._id,
//       cnic: user.cnic,
//       name: profileName, // Return the name from the linked profile
//       role: user.role, // Get the role directly from the authenticated user
//       profileId: user.profileId,
//       editModeEnabled: user.editModeEnabled,
